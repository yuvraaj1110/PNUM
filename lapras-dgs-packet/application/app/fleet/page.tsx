            ...
            <header className="absolute top-0 left-0 right-0 z-30 px-4 pt-4">
                <div className="fleet-glass-bar flex items-center justify-between px-5 py-3">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        {/* Connection status */}
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#1f1f1f]/80 border border-gray-800/50">
                            <div
                ...
                <div className="px-5 pt-5 pb-4 border-b border-white/5">
                    ...
                    <div className="relative mb-3">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/5 focus:border-yellow-500/40 outline-none rounded-xl py-2.5 pl-9 pr-4 text-sm text-gray-200 placeholder:text-gray-600 transition-all"
                        />
                    </div>
                ...
                {selectedJob && nearestPlumbers.length > 0 && (
                    <div className="px-4 py-4 border-t border-white/5">
                        <div className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-3 flex items-center gap-2">
                            <Route size={12} className="text-yellow-400" />
                        ...
                        <div className="space-y-2">
                            {nearestPlumbers.map((p, i) => (
                                <div
                                    key={p.id}
                                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5 border border-white/5 hover:border-yellow-500/20 transition-all"
                                >
        ...
        >
            ...
            <div className="space-y-1 mb-3">
                <div className="flex items-center gap-1.5 text-xs text-gray-400">
                    <Users size={11} className="text-yellow-500/40 shrink-0" />
            ...
            <div className="flex items-center justify-between">
                ...
                <ChevronRight
                    size={14}
                    className={`text-gray-700 transition-transform ${isSelected ? 'rotate-90 text-yellow-400' : 'group-hover:translate-x-0.5'
                        }`}
                />
            </div>
        </button>
